...
@Autonomous(name="Red Alliance Left Storage Unit", group="FTC22Auto_Store")
public class RedAllianceLeftStorageUnit extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        robot.turn(0.8,0);
        if(itemPos == TseDetector.Location.CENTER) robot.drive(Robot.Direction.BACKWARDS,0.8,25);
        else robot.drive(Robot.Direction.BACKWARDS,0.8,25);
